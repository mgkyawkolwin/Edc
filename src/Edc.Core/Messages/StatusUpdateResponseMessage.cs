...
public class StatusUpdateResponseMessage : ResponseMessage
{
    // private readonly byte[] _data;
    public StatusUpdateResponseMessage(byte[] data)
    {
        _data = data;
    }
    ...
    // {
    //     return _data.Take(new Range(3, _data.Length - 3)).ToArray();
    // }
